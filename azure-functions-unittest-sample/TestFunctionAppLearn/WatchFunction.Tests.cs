...
{
    public class TestWatchFunction
    {
        [Fact]
        public void Run_Success()
        {
            ...
            var response = FunctionAppLearn.WatchInfo.Run(request, logger);
            response.Wait();
        ...
        [Fact]
        public void Run_FailureNoQueryString()
        {
            var request = new DefaultHttpRequest(new DefaultHttpContext());
            var logger = NullLoggerFactory.Instance.CreateLogger("Null Logger");
        ...
        [Fact]
        public void Run_FailureNoModel()
        {
            var queryStringValue = "abc";
            var request = new DefaultHttpRequest(new DefaultHttpContext())
            {
